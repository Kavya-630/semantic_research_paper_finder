...
Original file is located at
    https://colab.research.google.com/drive/11xnL_NaWNxRD-fnOUe3lRJr0X-3-EEYh
"""
...
Original file located at
    https://colab.research.google.com/drive/1jBthqtOyoJeo1BjIEIIfBHMBvEdz_Usz
"""
...
@st.cache_data
def load_papers(json_path, limit=5000):
    papers = []
    try:
        ...
        st.error(f"Error: File not found at {json_path}. Make sure your Google Drive is mounted and the path is correct.")
...
dataset_path = st.sidebar.text_input("Path to the dataset", "/content/drive/MyDrive/arxiv-metadata-oai-snapshot.json")


# Load resources
model = load_model()
df = load_papers(dataset_path)
...
if search_button and query and index is not None and embeddings is not None:
...
elif search_button and (index is None or embeddings is None):
     st.warning("Dataset not loaded. Please check the file path in the sidebar.")